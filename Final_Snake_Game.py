...
def game_loop():
    ...
    if new_head in snake or new_head[0] < - WIDTH / 2 or new_head[0] > WIDTH / 2 \
        ...
        stamper.shape("Ivan_Snake/snake-head-20x20.gif")
...
screen.title("Snake")
screen.bgpic("Ivan_Snake/bg2.gif")
screen.register_shape("Ivan_Snake/snake-food-32x32.gif")
screen.register_shape("Ivan_Snake/snake-head-20x20.gif")
...
# Food
food = turtle.Turtle()
food.shape("Ivan_Snake/snake-food-32x32.gif")
